...
function getName(naam){ //In op welke regel in de HTML file wordt deze functie aangeroepen _____________ vul je antwoord in op de lijn

    // vul in wat naam is: naam is de ________is de stuk tekst___ vul je antwoord in op de lijn, je hebt de eerste letter al gekregen
    // vul in: naam heeft de waarde ___________________ vul je antwoord in op de lijn, je hebt de eerste letter al gekregen
...
getName(myStr);
// wat gebeurd er hierboven ___________ en wanneer gebeurt dat _als je erop kliktt_________ (tip ververs je pagina eens in je brouwser? vul je antwoord in op de lijn.
